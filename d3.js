!function () {
    ...
    function Ct(n, t, r, e) {
        ...
        var i = {}, o = oa.dispatch("beforesend", "progress", "load", "error"), a = {}, c = new XMLHttpRequest,
            l = null;
        ...
        function u(t, r, e, a, c, l, s, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g, b = c + p, w = l + v, S = Math.sqrt(_ * _ + b * b + w * w), k = Math.asin(w /= S),
                    E = Ma(Ma(w) - 1) < Fa || Ma(e - h) < Fa ? (e + h) / 2 : Math.atan2(b, _), N = n(E, k), A = N[0],
                    C = N[1], L = A - t, q = C - r, T = x * L - y * q;
    ...
    function Ae(n, t, r, e) {
        var u = Math.cos(t), i = Math.sin(t), o = Math.cos(e), a = Math.sin(e), c = u * Math.cos(n),
            l = u * Math.sin(n), s = o * Math.cos(r), f = o * Math.sin(r),
            h = 2 * Math.asin(Math.sqrt(tt(e - t) + u * o * tt(r - n))), g = 1 / Math.sin(h), p = h ? function (n) {
                var t = Math.sin(n *= h) * g, r = Math.sin(h - n) * g, e = r * c + t * s, u = r * l + t * f,
                    o = r * i + t * a;
    ...
    function eu(n, t) {
        var r = n.b;
        if (r) return !0;
        var e, u, i = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1], s = n.l, f = n.r, h = s.x, g = s.y,
    ...
    try {
        ...
        var pa = fa.Element.prototype, va = pa.setAttribute, da = pa.setAttributeNS,
            ma = fa.CSSStyleDeclaration.prototype, ya = ma.setProperty;
        ...
        function t(n, t, u, i, o) {
            return function () {
                ...
                var l, s = this, f = oa.event.target, h = s.parentNode, g = r.of(s, arguments), p = 0, v = n(),
                    d = ".drag" + (null == v ? "" : "-" + v), m = oa.select(u()).on(i + d, a).on(o + d, c), y = Y(),
                    x = t(h, v);
    ...
    oa.interpolateZoom = function (n, t) {
        ...
        function s() {
            ...
            var h, g = this, p = q.of(g, arguments), v = {}, d = 0,
                x = ".zoom-" + oa.event.changedTouches[0].identifier, M = "touchmove" + x, _ = "touchend" + x,
                b = oa.select(oa.event.target).on(M, i).on(_, f), w = oa.select(g).on(N, null).on(L, r), k = Y();
            H.call(g), r(), o(p)
        }
    ...
    oa.geo.path = function () {
        ...
        function n() {
            var n = "function" == typeof e ? e.apply(this, arguments) : e, t = ye(-n[0] * Ia, -n[1] * Ia, 0).invert,
                u = [];
    ...
    oa.layout.histogram = function () {
        ...
        function n(n, i) {
            ...
            var f = Si(s, Ei), h = Si(s, ki), g = Si(s, Ni), p = f.x - r(f, h) / 2, v = h.x + r(h, f) / 2,
                d = g.depth || 1;
        ...
        function n(n) {
            n.each(function () {
                var n, l = oa.select(this), s = this.__chart__ || r, f = this.__chart__ = r.copy(),
                    ...
                    m = oa.transition(p.order()).style("opacity", 1), y = Bi(f), x = l.selectAll(".domain").data([0]),
    ...
    oa.svg.brush = function () {
        ...
        function u() {
            ...
            var x, M, _ = this, b = oa.select(oa.event.target), w = a.of(_, arguments), S = oa.select(_), k = b.datum(),
                E = !/^(n|s)$/.test(k) && c, N = !/^(e|w)$/.test(k) && l, A = b.classed("extent"), C = Y(),
                L = oa.mouse(_), q = oa.select(fa).on("keydown.brush", u).on("keyup.brush", p);
        ...
        var i, o, a = M(n, "brushstart", "brush", "brushend"), c = null, l = null, s = [0, 0], f = [0, 0], h = !0,
            g = !0, p = Bl[0];
        return n.event = function (n) {
            n.each(function () {
